...
const QUESTIONS = [
  {
    ...
    correct: 1,
    explanation: "A espécie Iris Virginica possui as maiores pétalas (média de 5,55 cm). A Iris Setosa possui as menores (1,46 cm), mas é, de longe, a mais consistente, com um desvio padrão de apenas 0,17.",
  },
  {
